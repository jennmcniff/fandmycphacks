...
class EventStyles(object):
    ...
    Predefined colors
    """
    YELLOW = EventStyle(event_border=(110, 110, 110, 240), event_fill=(255, 234, 64, 180))
    RED = EventStyle(event_border=(110, 110, 110, 240), event_fill=(248, 98, 98, 180))
    BLUE = EventStyle(event_border=(110, 110, 110, 240), event_fill=(62, 117, 236, 180))
    PINK = EventStyle(event_border=(110, 110, 110, 240), event_fill=(248, 146, 194, 180))
    GRAY = EventStyle(event_border=(110, 110, 110, 240), event_fill=(187, 201, 198, 190))
